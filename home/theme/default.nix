...
in
{
  ...
  config =
    let
      ...
      # Calculate relative path from this module to the wallpapers directory
      wallpapersPath = ../../config/wallpapers;
    in
    {
      dotnix.theme = {
        inherit colorScheme;
        ...
        # Wallpaper path
        wallpaperPath = "${wallpapersPath}/${cfg.name}/${cfg.wallpaper}";
